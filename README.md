# DHTMLX React Gantt Jotai Demo

This project demonstrates how to integrate the DHTMLX React Gantt component with Jotai for state management in a React application. 
